        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50">
          <div className="text-center p-8 max-w-md">
            ...
            <div className="flex flex-col gap-2 text-center">
              ...
              <p className="text-gray-600 text-base">We encountered an unexpected error while processing your request.</p>
            </div>
            <div className="flex justify-center items-center mt-6">
              <button
                ...
                className="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-6 rounded-lg flex items-center gap-2 transition-colors duration-200 shadow-sm"
              >
                ← Back to Home
              </button>
            </div>
